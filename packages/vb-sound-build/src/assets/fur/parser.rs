...
fn effect_parser(bits: u8) -> binrw::BinResult<Option<FurEffect>> {
    ...
    Ok(Some(match effect {
        ...
        0x03 => FurEffect::Portamento(value),
        0x04 => FurEffect::Vibrato(value >> 4, value & 0xf),
        0x08 => FurEffect::SetPanning(value >> 4, value & 0xf),
        0x0a => FurEffect::VolumeSlide(value >> 4, value & 0xf),
        0x0b => FurEffect::JumpToOrder(value),
        0x0d => FurEffect::JumpToNextPattern(value),
        0x81 => FurEffect::SetVolumeLeft(value),
        0x82 => FurEffect::SetVolumeRight(value),
        0xd3 => FurEffect::VolumePortamento(value),
        0xd4 => FurEffect::VolumePortamento(value * 4),
